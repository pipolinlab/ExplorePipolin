...
def _get_pipolin_bounds(genome: Genome):
    ...
    left_edge = atts[0].start - 50 if atts[0].start < pipolbs[0].start else pipolbs[0].start - 50
    right_edge = atts[-1].end + 50 if atts[-1].end > pipolbs[-1].end else pipolbs[-1].end + 50
