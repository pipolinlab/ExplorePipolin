...
from explore_pipolin.common import Genome, Feature, Orientation, FeatureType, Contig, FeaturesContainer
...
class MiscTestCase(unittest.TestCase):
    def test_get_overlapping_feature(self):
        ...
        features_container: FeaturesContainer = FeaturesContainer(genome)
